            ...
            <div class="table-responsive">
                <table class="table ">
                    ...
                    <tbody>
                        ...
                        $query = "SELECT a.id, fecha, hora, b.nombreCompleto AS director, c.nombreCompleto AS supervisor, estatus 
                ...
                <div class="container" style="min-width: 100%;">
                    ...
                    <form id="formProcesarCortesia" onsubmit="formProcesarCortesia()">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-8">
                                <input type="number" class="form-control" id="notaEntrega" name="notaEntrega" required autocomplete="off">
                            </div>
                        </div>
                        <div class="form-group row">
...
<script>
    ...
    function formProcesarCortesia() {
        ...
        const productosEntregados = $("#productosEntregados").val();
