                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-8">
                                <select class="form-select form-control" id="entregado" name="entregado" aria-label="Floating label select example" required>
                                    <option value="">--</option>
                                    <?php
                                    $query = "SELECT id, rol, nombreCompleto FROM trazabilidad_usuario WHERE rol = 'Tesoreria' OR rol = 'Director' ORDER BY nombreCompleto;";
...
<script>
    ...
    function formEntregarRecibo() {
        ...
        $.ajax({
            url: './controllers/trazabilidadEntregarRecibo.php',
            type: 'POST',
            data: formdata,
            dataType: 'json',
